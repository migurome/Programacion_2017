...
void crearTabla(tIndicePalabras & tabla, const string &nombreArchivoInicial, tListaCadenas & totales, tListaCadenas & visitados, tListaCadenas & noVisitados, tListaCadenas & enlace, tMatriz & L);// rellena la tabla tabla, tras haberla inicializado(a vacía).
